...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-container post-format">
        ...
        <header class="entry-header">
            ...
            <h2 class="entry-format"><a href="<?php echo get_post_format_link( 'Image' ); ?>" title="<?php _e( 'All Image Posts', 'catch-kathmandu' ); ?>"><?php _e( 'Image', 'catch-kathmandu' ); ?></a></h2>
        </header><!-- .entry-header -->  
        ...
        <footer class="entry-meta">
            ...
            <?php if ( comments_open() && ( $options[ 'commenting_setting' ] != 'disable' ) ) : ?>
            	<span class="sep"> | </span>
