...
$sidebar_layout = array(
       ...
       'right-sidebar' => array(
		...
		'no-sidebar-full-width' => array(
						...
						'label' 	=> __( 'No sidebar, Full Width', 'catch-kathmandu' ),
        ...
        'no-sidebar-one-column' => array(
						...
						'label' 	=> __( 'No Sidebar, One Column', 'catch-kathmandu' ),
...
$sidebar_options = array(
	'main-sidebar' => array(
		'id'		=> 'catchkathmandu-sidebar-options',
		'value' 	=> 'default-sidebar',
		'label' 	=> __( 'Default Sidebar', 'catch-kathmandu' )
	),
	'optional-sidebar-one' => array(
		'id' => 'catchkathmandu-sidebar-options',
		'value' => 'optional-sidebar-one',
		'label' => __( 'Optional Sidebar One', 'catch-kathmandu' )
	),
	'optional-sidebar-two' => array(
		'id' => 'catchkathmandu-sidebar-options',
		'value' => 'optional-sidebar-two',
		'label' => __( 'Optional Sidebar Two', 'catch-kathmandu' )
	),
	'optional-sidebar-three' => array(
		'id' => 'catchkathmandu-sidebar-options',
		'value' => 'optional-sidebar-three',
		'label' => __( 'Optional Sidebar three', 'catch-kathmandu' )
	)	
);
...
function catchkathmandu_meta_options() {  
    ...
    <div class="catchkathmandu-meta" style="border-bottom: 2px solid #dfdfdf; margin-bottom: 10px; padding-bottom: 10px;">
    	<h4 class="title"><?php _e('Select Sidebar', 'catch-kathmandu'); ?></h4>   
