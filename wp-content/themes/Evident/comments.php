...
<section id="respond" class="respond-form">
	...
	<p><textarea name="comment" cols="100" rows="7" id="comment" placeholder="<?php _e('Your Comment here...'); ?>" tabindex="4"></textarea></p>
	
	<p>
	  <input name="submit" type="submit" id="submit" class="button" tabindex="5" value="<?php _e('Add Comment'); ?>" />
