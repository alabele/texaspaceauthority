				...
				if( $instance[$key] != '' ) { ?>
					<li>
						<a href="<?php echo $key == 'email' ? 'mailto:' . $val : $val; ?>" class="<?php echo 'enable' == $use_fade_effect ? 'fade' : 'no-fade'; ?>" target="_blank">
							<img src="<?php echo  get_template_directory_uri(). '/inc/tipsy-social-icons/images/' . $icon_size . '/' . $key . '_' . $icon_size . '.png' ; ?>" alt="<?php echo ucfirst( $key ); ?>" class="tipsy-social-icons" />
						</a>
					</li><?php
				} // end if
			} // end if
