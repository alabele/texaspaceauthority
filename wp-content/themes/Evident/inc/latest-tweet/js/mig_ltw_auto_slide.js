jQuery(document).ready(function(){
	...
	if( jQuery('.mig_ltw_autoslide').length > 0 ) {
	
		jQuery('.mig_ltw_autoslide').each(function(){
			...
			if ( $tweets.length > 1 ) {
				...
				ltw_interval = setInterval(mig_ltw_next_one, ltw_the_delay*1000);
